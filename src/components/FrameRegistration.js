...
//         </div>
//       </div>
//       <div className="self-stretch flex flex-col items-center justify-start pt-[33px] px-[33px] pb-[34px] box-border relative gap-[22px] max-w-full mq450:pt-[21px] mq450:pb-[22px] mq450:box-border">
//         <div className="w-full h-full absolute my-0 mx-[!important] top-[-0.1px] right-[0.2px] bottom-[3.1px] left-[0.2px] z-[1]">
...
//               <div className="absolute h-full w-full top-[-1.03%] right-[-0.03%] bottom-[1.03%] left-[0.03%] rounded-3xs bg-light-goku" />
//             </div>
//             <input
...
//           </div>
//         </div>
//         <button className="cursor-pointer [border:none] p-0 bg-[transparent] self-stretch flex flex-row items-center justify-start max-w-full">
//           <div className="h-[43.9px] w-[356.8px] relative max-w-full z-[2]">
//             <div
